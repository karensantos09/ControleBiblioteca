...
namespace ControleBiblioteca.Controllers
{
    public class GastosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GastoId,Descricao,Valor,Data")] Gasto gasto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GastoId,Descricao,Valor,Data")] Gasto gasto)
        {
            if (id != gasto.GastoId)
            {
                return NotFound();
