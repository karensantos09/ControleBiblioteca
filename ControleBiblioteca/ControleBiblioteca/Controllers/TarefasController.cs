...
namespace ControleBiblioteca.Controllers
{
    public class TarefasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TarefaId,Titulo,Descricao,Concluido,DataCriacao,DataConclusao")] Tarefa tarefa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TarefaId,Titulo,Descricao,Concluido,DataCriacao,DataConclusao")] Tarefa tarefa)
        {
